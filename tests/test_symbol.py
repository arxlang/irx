...
#     # Enter global scope
#     register_table.append()
#     register_table.increase(2)  # Global: 2

#     # Enter function scope
#     register_table.append()
#     register_table.increase(3)  # Function: 3, Global: 2

#     assert register_table.last == [TEST_INCREMENT_1]
#     assert register_table.stack == [2, 3]

#     # Modify function scope
#     register_table.redefine(5)
#     assert register_table.stack == [2, 5]

#     # Exit function scope
#     register_table.pop()
#     assert register_table.stack == [2]
...
def test_nested_context_operations(register_table: RegisterTable) -> None:
    ...
    # Enter global scope
    register_table.append()
    register_table.increase(TEST_VALUE_1)  # Global: 2 (using TEST_VALUE_1 = 2)

    # Enter function scope
    register_table.append()
    register_table.increase(
        TEST_INCREMENT_1
    )  # Function: 3 (using TEST_INCREMENT_1 = 3)

    # Changed to use constants consistently
    assert register_table.last == TEST_INCREMENT_1  # Instead of hardcoded 3
    assert register_table.stack == [TEST_VALUE_1, TEST_INCREMENT_1]

    # Modify function scope
    register_table.redefine(TEST_REDEFINE // 2)  # Using TEST_REDEFINE = 10 → 5
