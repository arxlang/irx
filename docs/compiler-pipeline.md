...
architectural building blocks, not incidental helpers. The protocol gives mixins
and runtime feature declarations a stable typing contract, while the concrete
core class owns the shared mutable lowering state and lifecycle.
